...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="the task name for pre-training or fine-tuning",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="the type of forecasting task",
    )
    parser.add_argument(
    ...
    # for the pre-training of SynthTime
    parser.add_argument(
    ...
    if args.task_name == "pre-train":
        ...
        print_args(args=args, accelerator=accelerator)

        # 构建用于预训练的算法模块
        exp = Exp_Pretrain(configs=args, accelerator=accelerator)
    ...
    if args.task_name == "long_term_forecast":
        ...
        raise ValueError("Wrong inputs for the pre-training or fine-tuning tasks!")
